...
- **CRE8-OPS-REQ-0059**: Any open `critical` or `high` risk in [`RISK_REGISTER.md`](RISK_REGISTER.md) without an accepted ADR waiver **MUST** block production promotion.
...
- **CRE8-OPS-REQ-0061**: Contract schema and example coverage **MUST** be 100% for routes listed in [`ROUTE_INVENTORY_REFERENCE.md`](ROUTE_INVENTORY_REFERENCE.md) before production promotion.
