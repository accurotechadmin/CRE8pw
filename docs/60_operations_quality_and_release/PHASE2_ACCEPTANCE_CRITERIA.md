...
- **CRE8-OPS-REQ-0013**: Deferred Phase 2 breadth items retained after a bundle run **MUST** remain listed in [`PHASE2_PROGRESS_BOARD.md`](PHASE2_PROGRESS_BOARD.md) with owner, due date, and decision reference.
