...
- **CRE8-OPS-REQ-0013**: Deferred Phase 2 breadth items retained after a bundle run **MUST** remain listed in [`PHASE2_PROGRESS_BOARD.md`](../../reports/session_handoffs/archive/2026-04/PHASE2_PROGRESS_BOARD.md) with owner, due date, and decision reference.
...
- **CRE8-OPS-REQ-0015**: Any unresolved Phase 2 exception retained after acceptance-bundle execution **MUST** be listed in [`PHASE2_UNRESOLVED_EXCEPTIONS_REGISTER.md`](PHASE2_UNRESOLVED_EXCEPTIONS_REGISTER.md) before merge.
