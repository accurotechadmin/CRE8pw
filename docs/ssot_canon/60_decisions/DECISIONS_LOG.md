...
- **2026-04-28**: Adopted activation governance for staged PDP rollout; read-route comparison telemetry and write-route enforcement cutover are release-blocked on mismatch resolution, contract/security passes, and rollback readiness evidence (ADR-010).
