...
2. **Contract sync checker**: detect route diffs between `docs/ssot_canon/20_contracts/ROUTE_INVENTORY_REFERENCE.md` and `docs/ssot_canon/openapi/cre8.v1.yaml`.
3. **Error code sync checker**: verify error/detail codes used in examples/tests are registered in `docs/ssot_canon/20_contracts/ERROR_CODE_CATALOG.md`.
...
- canonical artifact at `docs/ssot_canon/evidence/automation/ssot_report.json` (or equivalent CI artifact path).
