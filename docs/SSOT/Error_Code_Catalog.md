...
| 401 | auth_required / auth_invalid | missing_bearer, token_invalid, token_type_mismatch, token_expired | conditional (after re-auth) | clear session, route to login |
...
| 422 | validation_failed | required, invalid_format, invalid_enum, out_of_range | no | inline field errors |
...
- Detail-code behavior must remain consistent with `Request_Pipeline_Reference.md` and `UI_Parity_Contract.md`.
