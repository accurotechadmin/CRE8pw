...
- **ADR-004-REQ-0010**: Each authoring session **MUST** complete and publish a session handoff under `reports/session_handoffs/SESSION_HANDOFF_<UTC>.md`, update `reports/session_handoffs/LATEST_SESSION_HANDOFF.md` to point at it, refresh `reports/session_handoffs/PHASE3_PROGRESS_BOARD.md` (authored under slice `P3-S0.3`), and archive the verbatim final response under `reports/session_responses/<UTC>_RESPONSE.md`.
