...
| RISK-010 | Authoring drift between concurrent Phase 3 slices | delivery | 4 | 4 | 16 | high | Program Traceability WG | open | Slice predecessor enforcement; one slice in progress per author at a time; mandatory progress board updates per session | HOOK-SSOT-PHASE2-ACCEPTANCE-BUNDLE, HOOK-TRACE-DECISION-ADR-LINK | ADR-004-REQ-0002, ADR-004-REQ-0010, ADR-004-REQ-0013 | reports/PHASE3_AUTHORING_PROGRAM_PLAN.md, reports/session_handoffs/PHASE3_PROGRESS_BOARD.md | 2026-06-30 |
...
| RISK-014 | Trace coverage regression while adding requirements | delivery | 4 | 4 | 16 | high | Program Traceability WG | open | CI fails on `untraced_requirements > 0` once `composer phase3:final-acceptance-bundle` is wired | HOOK-TRACE-MATRIX-COVERAGE, HOOK-SSOT-REPORT-COVERAGE-COVERAGE | ADR-004-REQ-0006, ADR-004-REQ-0011 | reports/ssot/coverage_latest.json | 2026-06-30 |
