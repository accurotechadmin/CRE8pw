...
| CRE8-CONTRACT-REQ-0010 | CRE8-CONTRACTS-API-GUIDE | docs/30_contracts_and_interfaces/API_CONTRACT_GUIDE.md | HOOK-CONTRACT-ROUTE-INVENTORY-PARITY | script (`composer docs:ssot:route-parity`) | API Contracts WG | provisional-normative | reports/ssot/coverage_latest.json |
