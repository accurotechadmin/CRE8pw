...
| CRE8-ARCH-REQ-0001 | CRE8-ARCH-CANONICAL-TERMINOLOGY | docs/10_product_and_architecture/CANONICAL_TERMINOLOGY.md | HOOK-SSOT-GLOSSARY-COVERAGE | automated | Platform Architecture WG | normative | composer docs:ssot:glossary-check |
| CRE8-ARCH-REQ-0002 | CRE8-ARCH-CANONICAL-TERMINOLOGY | docs/10_product_and_architecture/CANONICAL_TERMINOLOGY.md | HOOK-SSOT-GLOSSARY-COVERAGE | automated | Platform Architecture WG | normative | composer docs:ssot:glossary-check |
| CRE8-ARCH-REQ-0003 | CRE8-ARCH-CANONICAL-TERMINOLOGY | docs/10_product_and_architecture/CANONICAL_TERMINOLOGY.md | HOOK-SSOT-GLOSSARY-COVERAGE | automated | Platform Architecture WG | normative | composer docs:ssot:glossary-check |
| CRE8-ARCH-REQ-0004 | CRE8-ARCH-CANONICAL-TERMINOLOGY | docs/10_product_and_architecture/CANONICAL_TERMINOLOGY.md | HOOK-AUTH-DECISION-REASON-MAPPING | automated | Identity & Policy WG | normative | composer test:contract:auth-reasons |
| CRE8-ARCH-REQ-0005 | CRE8-ARCH-CANONICAL-TERMINOLOGY | docs/10_product_and_architecture/CANONICAL_TERMINOLOGY.md | HOOK-SEC-LIFECYCLE-PROPAGATION | automated | Security WG | normative | composer test:contract:lifecycle |
| CRE8-OPS-REQ-0008 | CRE8-OPS-VERIFICATION-STRATEGY | docs/60_operations_quality_and_release/VERIFICATION_STRATEGY.md | HOOK-SSOT-GLOSSARY-COVERAGE | automated | Operations Quality WG | provisional-normative | composer docs:ssot:glossary-check |
| CRE8-ARCH-REQ-0010 | CRE8-ARCH-SURFACES | docs/10_product_and_architecture/ARCHITECTURE_AND_SURFACES.md | HOOK-CONTRACT-SURFACE-PARITY | manual | Platform Architecture WG | normative | docs/evidence/templates/README.md |
| CRE8-ARCH-REQ-0011 | CRE8-ARCH-SURFACES | docs/10_product_and_architecture/ARCHITECTURE_AND_SURFACES.md | HOOK-CONTRACT-SURFACE-PARITY | automated | Platform Architecture WG | normative | composer test:contract:surface-parity |
| CRE8-ARCH-REQ-0012 | CRE8-ARCH-SURFACES | docs/10_product_and_architecture/ARCHITECTURE_AND_SURFACES.md | HOOK-CONTRACT-ROUTE-INVENTORY-PARITY | automated | Platform Architecture WG | normative | composer docs:ssot:route-parity |
| CRE8-ARCH-REQ-0013 | CRE8-ARCH-SURFACES | docs/10_product_and_architecture/ARCHITECTURE_AND_SURFACES.md | HOOK-CONTRACT-ERROR-CODE-COVERAGE | automated | Platform Architecture WG | normative | composer docs:ssot:error-code-coverage |
| CRE8-ARCH-REQ-0014 | CRE8-ARCH-SURFACES | docs/10_product_and_architecture/ARCHITECTURE_AND_SURFACES.md | HOOK-AUTH-DECISION-REASON-MAPPING | automated | Platform Architecture WG | normative | composer test:contract:auth-reasons |
| CRE8-ARCH-REQ-0015 | CRE8-ARCH-SURFACES | docs/10_product_and_architecture/ARCHITECTURE_AND_SURFACES.md | HOOK-SSOT-COMMAND-EXIT-SEMANTICS | automated | Platform Architecture WG | normative | composer validate --strict |
| CRE8-ARCH-REQ-0016 | CRE8-ARCH-SURFACES | docs/10_product_and_architecture/ARCHITECTURE_AND_SURFACES.md | HOOK-SSOT-REPORT-COVERAGE-COVERAGE | automated | Platform Architecture WG | normative | composer docs:ssot:report |
| CRE8-ARCH-REQ-0020 | CRE8-ARCH-DEPENDENCY-BASELINE | docs/10_product_and_architecture/DEPENDENCY_BASELINE.md | HOOK-CONTRACT-SURFACE-PARITY | automated | Platform Architecture WG | normative | composer test:contract:surface-parity |
| CRE8-ARCH-REQ-0021 | CRE8-ARCH-DEPENDENCY-BASELINE | docs/10_product_and_architecture/DEPENDENCY_BASELINE.md | HOOK-SSOT-COMPAT-DECLARATION | automated | Platform Architecture WG | normative | composer docs:ssot:compat-declaration |
| CRE8-ARCH-REQ-0022 | CRE8-ARCH-DEPENDENCY-BASELINE | docs/10_product_and_architecture/DEPENDENCY_BASELINE.md | HOOK-AUTH-LIFECYCLE-ENFORCEMENT | automated | Platform Architecture WG | normative | composer test:contract:lifecycle |
| CRE8-ARCH-REQ-0023 | CRE8-ARCH-DEPENDENCY-BASELINE | docs/10_product_and_architecture/DEPENDENCY_BASELINE.md | HOOK-CONTRACT-ERROR-DETERMINISM | automated | Platform Architecture WG | normative | composer test:contract:error |
| CRE8-ARCH-REQ-0024 | CRE8-ARCH-DEPENDENCY-BASELINE | docs/10_product_and_architecture/DEPENDENCY_BASELINE.md | HOOK-CONTRACT-SCHEMA-COVERAGE | automated | Platform Architecture WG | normative | composer test:contract:request-schema |
| CRE8-ARCH-REQ-0025 | CRE8-ARCH-DEPENDENCY-BASELINE | docs/10_product_and_architecture/DEPENDENCY_BASELINE.md | HOOK-SSOT-COMMAND-EXIT-SEMANTICS | automated | Platform Architecture WG | normative | composer phase2:acceptance-bundle |
| CRE8-ARCH-REQ-0026 | CRE8-ARCH-DEPENDENCY-BASELINE | docs/10_product_and_architecture/DEPENDENCY_BASELINE.md | HOOK-CONTRACT-COMPAT-DECLARATION | automated | Platform Architecture WG | normative | composer docs:ssot:compat-declaration |
| CRE8-ARCH-REQ-0027 | CRE8-ARCH-DEPENDENCY-BASELINE | docs/10_product_and_architecture/DEPENDENCY_BASELINE.md | HOOK-CONTRACT-SURFACE-PARITY | automated | Platform Architecture WG | normative | composer test:contract:surface-parity |
| CRE8-ARCH-REQ-0028 | CRE8-ARCH-DEPENDENCY-BASELINE | docs/10_product_and_architecture/DEPENDENCY_BASELINE.md | HOOK-SSOT-COMMAND-EXIT-SEMANTICS | automated | Platform Architecture WG | normative | composer phase2:acceptance-bundle |
| CRE8-ARCH-REQ-0029 | CRE8-ARCH-DEPENDENCY-BASELINE | docs/10_product_and_architecture/DEPENDENCY_BASELINE.md | HOOK-CONTRACT-SURFACE-PARITY | automated | Platform Architecture WG | normative | composer test:contract:surface-parity |
| CRE8-ARCH-REQ-0030 | CRE8-ARCH-DEPENDENCY-BASELINE | docs/10_product_and_architecture/DEPENDENCY_BASELINE.md | HOOK-SSOT-PHASE2-ACCEPTANCE-BUNDLE | automated | Platform Architecture WG | normative | composer phase2:acceptance-bundle |
| CRE8-ARCH-REQ-0031 | CRE8-ARCH-REQUEST-PIPELINE | docs/10_product_and_architecture/REQUEST_PIPELINE_AND_MIDDLEWARE_CONTRACT.md | HOOK-CONTRACT-POLICY-ORDER | automated | Platform Architecture WG | normative | composer test:contract:auth |
| CRE8-ARCH-REQ-0032 | CRE8-ARCH-REQUEST-PIPELINE | docs/10_product_and_architecture/REQUEST_PIPELINE_AND_MIDDLEWARE_CONTRACT.md | HOOK-CONTRACT-POLICY-ORDER | automated | Platform Architecture WG | normative | composer test:contract:auth |
| CRE8-ARCH-REQ-0033 | CRE8-ARCH-REQUEST-PIPELINE | docs/10_product_and_architecture/REQUEST_PIPELINE_AND_MIDDLEWARE_CONTRACT.md | HOOK-CONTRACT-POLICY-ORDER | automated | Platform Architecture WG | normative | composer test:contract:auth |
| CRE8-ARCH-REQ-0034 | CRE8-ARCH-REQUEST-PIPELINE | docs/10_product_and_architecture/REQUEST_PIPELINE_AND_MIDDLEWARE_CONTRACT.md | HOOK-AUTH-DECISION-REASON-MAPPING | automated | Platform Architecture WG | normative | composer test:contract:auth-reasons |
| CRE8-ARCH-REQ-0035 | CRE8-ARCH-REQUEST-PIPELINE | docs/10_product_and_architecture/REQUEST_PIPELINE_AND_MIDDLEWARE_CONTRACT.md | HOOK-CONTRACT-ERROR-DETERMINISM | automated | Platform Architecture WG | normative | composer test:contract:error |
| CRE8-ARCH-REQ-0036 | CRE8-ARCH-REQUEST-PIPELINE | docs/10_product_and_architecture/REQUEST_PIPELINE_AND_MIDDLEWARE_CONTRACT.md | HOOK-CONTRACT-ERROR-DETERMINISM | automated | Platform Architecture WG | normative | composer test:contract:error |
| CRE8-ARCH-REQ-0037 | CRE8-ARCH-REQUEST-PIPELINE | docs/10_product_and_architecture/REQUEST_PIPELINE_AND_MIDDLEWARE_CONTRACT.md | HOOK-SSOT-COMMAND-EXIT-SEMANTICS | automated | Platform Architecture WG | normative | composer docs:ssot:report |
| CRE8-ARCH-REQ-0038 | CRE8-ARCH-PRODUCT-SYSTEM | docs/10_product_and_architecture/CRE8_PRODUCT_AND_SYSTEM_SPEC.md | HOOK-CONTRACT-SURFACE-PARITY | automated | Platform Architecture WG | normative | composer test:contract:surface-parity |
| CRE8-ARCH-REQ-0039 | CRE8-ARCH-PRODUCT-SYSTEM | docs/10_product_and_architecture/CRE8_PRODUCT_AND_SYSTEM_SPEC.md | HOOK-IDENTITY-ID-FIRST-ISSUANCE | automated | Platform Architecture WG | normative | composer test:contract:identity-issuance |
| CRE8-ARCH-REQ-0040 | CRE8-ARCH-PRODUCT-SYSTEM | docs/10_product_and_architecture/CRE8_PRODUCT_AND_SYSTEM_SPEC.md | HOOK-IDENTITY-UTILITY-CONTEXT-ISOLATION | automated | Platform Architecture WG | normative | composer test:contract:identity-context |
| CRE8-ARCH-REQ-0041 | CRE8-ARCH-PRODUCT-SYSTEM | docs/10_product_and_architecture/CRE8_PRODUCT_AND_SYSTEM_SPEC.md | HOOK-CONTRACT-SURFACE-PARITY | automated | Platform Architecture WG | normative | composer test:contract:surface-parity |
| CRE8-ARCH-REQ-0042 | CRE8-ARCH-PRODUCT-SYSTEM | docs/10_product_and_architecture/CRE8_PRODUCT_AND_SYSTEM_SPEC.md | HOOK-CONTRACT-FEED-METADATA-STABILITY | automated | Platform Architecture WG | normative | composer test:contract:feed |
| CRE8-ARCH-REQ-0043 | CRE8-ARCH-PRODUCT-SYSTEM | docs/10_product_and_architecture/CRE8_PRODUCT_AND_SYSTEM_SPEC.md | HOOK-AUTH-LIFECYCLE-ENFORCEMENT | automated | Platform Architecture WG | normative | composer test:contract:lifecycle |
| CRE8-ARCH-REQ-0044 | CRE8-ARCH-HUMAN-OPERATING-MODEL | docs/10_product_and_architecture/CRE8_HUMAN_OPERATING_MODEL.md | HOOK-SSOT-OWNER-PRESENCE | automated | Platform Architecture WG | normative | composer docs:ssot:review-gate-check |
| CRE8-ARCH-REQ-0045 | CRE8-ARCH-HUMAN-OPERATING-MODEL | docs/10_product_and_architecture/CRE8_HUMAN_OPERATING_MODEL.md | HOOK-TRACE-MATRIX-COVERAGE | automated | Platform Architecture WG | normative | composer docs:ssot:report |
| CRE8-ARCH-REQ-0046 | CRE8-ARCH-HUMAN-OPERATING-MODEL | docs/10_product_and_architecture/CRE8_HUMAN_OPERATING_MODEL.md | HOOK-SSOT-PHASE2-ACCEPTANCE-BUNDLE | automated | Platform Architecture WG | normative | composer phase2:acceptance-bundle |
| CRE8-ARCH-REQ-0047 | CRE8-ARCH-HUMAN-OPERATING-MODEL | docs/10_product_and_architecture/CRE8_HUMAN_OPERATING_MODEL.md | HOOK-TRACE-DECISION-ADR-LINK | manual | Platform Architecture WG | normative | docs/evidence/templates/README.md |
| CRE8-ARCH-REQ-0048 | CRE8-ARCH-HUMAN-OPERATING-MODEL | docs/10_product_and_architecture/CRE8_HUMAN_OPERATING_MODEL.md | HOOK-SSOT-PHASE2-ACCEPTANCE-BUNDLE | automated | Platform Architecture WG | normative | composer phase2:acceptance-bundle |
| CRE8-IDPOL-REQ-0001 | CRE8-IDPOL-PERMISSION-VOCAB | docs/20_identity_delegation_and_policy/PERMISSION_VOCABULARY.md | HOOK-PERMISSION-VOCAB-RESOLVE | manual | Identity & Policy WG | normative | docs/evidence/templates/README.md |
| CRE8-IDPOL-REQ-0002 | CRE8-IDPOL-PERMISSION-VOCAB | docs/20_identity_delegation_and_policy/PERMISSION_VOCABULARY.md | HOOK-AUTH-DECISION-REASON-MAPPING | automated | Identity & Policy WG | normative | composer test:contract:auth-reasons |
| CRE8-IDPOL-REQ-0003 | CRE8-IDPOL-PERMISSION-VOCAB | docs/20_identity_delegation_and_policy/PERMISSION_VOCABULARY.md | HOOK-AUTH-INHERITANCE-BOUNDARY | manual | Identity & Policy WG | normative | docs/evidence/templates/README.md |
| CRE8-IDPOL-REQ-0004 | CRE8-IDPOL-PERMISSION-VOCAB | docs/20_identity_delegation_and_policy/PERMISSION_VOCABULARY.md | HOOK-PERMISSION-VOCAB-RESOLVE | manual | Identity & Policy WG | normative | docs/evidence/templates/README.md |
| CRE8-IDPOL-REQ-0005 | CRE8-IDPOL-PERMISSION-VOCAB | docs/20_identity_delegation_and_policy/PERMISSION_VOCABULARY.md | HOOK-TRACE-MATRIX-COVERAGE | automated | Identity & Policy WG | normative | composer docs:ssot:report |
| CRE8-IDPOL-REQ-0006 | CRE8-IDPOL-PRINCIPAL-CAPABILITY-MATRIX | docs/20_identity_delegation_and_policy/PRINCIPAL_TYPES_AND_CAPABILITY_MATRIX.md | HOOK-CAPABILITY-MATRIX-COMPLETE | manual | Identity & Policy WG | normative | docs/evidence/templates/README.md |
| CRE8-IDPOL-REQ-0007 | CRE8-IDPOL-PRINCIPAL-CAPABILITY-MATRIX | docs/20_identity_delegation_and_policy/PRINCIPAL_TYPES_AND_CAPABILITY_MATRIX.md | HOOK-CAPABILITY-MATRIX-COMPLETE | manual | Identity & Policy WG | normative | docs/evidence/templates/README.md |
| CRE8-IDPOL-REQ-0008 | CRE8-IDPOL-PRINCIPAL-CAPABILITY-MATRIX | docs/20_identity_delegation_and_policy/PRINCIPAL_TYPES_AND_CAPABILITY_MATRIX.md | HOOK-AUTH-INHERITANCE-BOUNDARY | manual | Identity & Policy WG | normative | docs/evidence/templates/README.md |
| CRE8-IDPOL-REQ-0009 | CRE8-IDPOL-PRINCIPAL-CAPABILITY-MATRIX | docs/20_identity_delegation_and_policy/PRINCIPAL_TYPES_AND_CAPABILITY_MATRIX.md | HOOK-AUTH-LIFECYCLE-ENFORCEMENT | automated | Identity & Policy WG | normative | composer test:contract:lifecycle |
| CRE8-IDPOL-REQ-0010 | CRE8-IDPOL-KEYCHAIN-RESOLUTION | docs/20_identity_delegation_and_policy/KEYCHAIN_COMPOSITION_AND_RESOLUTION_SPEC.md | HOOK-AUTH-INHERITANCE-BOUNDARY | manual | Identity & Policy WG | normative | docs/evidence/templates/README.md |
| CRE8-IDPOL-REQ-0011 | CRE8-IDPOL-KEYCHAIN-RESOLUTION | docs/20_identity_delegation_and_policy/KEYCHAIN_COMPOSITION_AND_RESOLUTION_SPEC.md | HOOK-DELEGATION-STATE-MACHINE-CONSISTENCY | manual | Identity & Policy WG | normative | docs/evidence/templates/README.md |
| CRE8-IDPOL-REQ-0012 | CRE8-IDPOL-KEYCHAIN-RESOLUTION | docs/20_identity_delegation_and_policy/KEYCHAIN_COMPOSITION_AND_RESOLUTION_SPEC.md | HOOK-AUTH-LIFECYCLE-ENFORCEMENT | automated | Identity & Policy WG | normative | composer test:contract:lifecycle |
| CRE8-IDPOL-REQ-0013 | CRE8-IDPOL-KEYCHAIN-RESOLUTION | docs/20_identity_delegation_and_policy/KEYCHAIN_COMPOSITION_AND_RESOLUTION_SPEC.md | HOOK-AUTH-DECISION-REASON-MAPPING | automated | Identity & Policy WG | normative | composer test:contract:auth-reasons |
| CRE8-IDPOL-REQ-0014 | CRE8-IDPOL-KEYCHAIN-RESOLUTION | docs/20_identity_delegation_and_policy/KEYCHAIN_COMPOSITION_AND_RESOLUTION_SPEC.md | HOOK-AUTH-DECISION-REASON-MAPPING | automated | Identity & Policy WG | normative | composer test:contract:auth-reasons |
| CRE8-IDPOL-REQ-0015 | CRE8-IDPOL-USAGE-SCENARIOS | docs/20_identity_delegation_and_policy/USAGE_SCENARIOS_AND_PERMISSION_STORIES.md | HOOK-CONTRACT-POLICY-ORDER | automated | Identity & Policy WG | normative | composer test:contract:auth |
| CRE8-IDPOL-REQ-0016 | CRE8-IDPOL-USAGE-SCENARIOS | docs/20_identity_delegation_and_policy/USAGE_SCENARIOS_AND_PERMISSION_STORIES.md | HOOK-CONTRACT-POLICY-ORDER | automated | Identity & Policy WG | normative | composer test:contract:auth |
| CRE8-IDPOL-REQ-0017 | CRE8-IDPOL-USAGE-SCENARIOS | docs/20_identity_delegation_and_policy/USAGE_SCENARIOS_AND_PERMISSION_STORIES.md | HOOK-AUTH-LIFECYCLE-ENFORCEMENT | automated | Identity & Policy WG | normative | composer test:contract:lifecycle |
| CRE8-IDPOL-REQ-0018 | CRE8-IDPOL-USAGE-SCENARIOS | docs/20_identity_delegation_and_policy/USAGE_SCENARIOS_AND_PERMISSION_STORIES.md | HOOK-CONTRACT-POLICY-ORDER | automated | Identity & Policy WG | normative | composer test:contract:auth |
| CRE8-IDPOL-REQ-0019 | CRE8-IDPOL-DELEGATION-STATE-MACHINE | docs/20_identity_delegation_and_policy/DELEGATION_STATE_MACHINE.md | HOOK-DELEGATION-STATE-MACHINE-CONSISTENCY | manual | Identity & Policy WG | normative | docs/evidence/templates/README.md |
...
| CRE8-CONTRACT-REQ-0063 | CRE8-CONTRACTS-ENDPOINT-EXAMPLES | docs/30_contracts_and_interfaces/Endpoint_Examples_All_Routes.md | HOOK-CONTRACT-SCHEMA-COVERAGE | automated | API Contracts WG | provisional-normative | composer test:contract:request-schema |
| CRE8-CONTRACT-REQ-0064 | CRE8-CONTRACTS-ENDPOINT-EXAMPLES | docs/30_contracts_and_interfaces/Endpoint_Examples_All_Routes.md | HOOK-CONTRACT-EXAMPLE-COVERAGE | automated | API Contracts WG | provisional-normative | composer test:contract:identity-context |
| CRE8-CONTRACT-REQ-0065 | CRE8-CONTRACTS-ENDPOINT-EXAMPLES | docs/30_contracts_and_interfaces/Endpoint_Examples_All_Routes.md | HOOK-CONTRACT-EXAMPLE-COVERAGE | automated | API Contracts WG | provisional-normative | composer test:contract:request-schema |
| CRE8-CONTRACT-REQ-0066 | CRE8-CONTRACTS-ENDPOINT-EXAMPLES | docs/30_contracts_and_interfaces/Endpoint_Examples_All_Routes.md | HOOK-CONTRACT-ROUTE-INVENTORY-PARITY | automated | API Contracts WG | provisional-normative | composer docs:ssot:route-parity |
| CRE8-CONTRACT-REQ-0067 | CRE8-CONTRACTS-WEBHOOK-INTEGRATION | docs/30_contracts_and_interfaces/WEBHOOK_AND_INTEGRATION_CONTRACT.md | HOOK-CONTRACT-COMPAT-DECLARATION | automated | API Contracts WG | provisional-normative | composer docs:ssot:compat-declaration |
| CRE8-CONTRACT-REQ-0068 | CRE8-CONTRACTS-WEBHOOK-INTEGRATION | docs/30_contracts_and_interfaces/WEBHOOK_AND_INTEGRATION_CONTRACT.md | HOOK-CONTRACT-COMPAT-DECLARATION | automated | API Contracts WG | provisional-normative | composer docs:ssot:compat-declaration |
