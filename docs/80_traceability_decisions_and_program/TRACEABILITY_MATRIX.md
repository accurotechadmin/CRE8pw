...
| CRE8-TRACE-REQ-0091 | CRE8-TRACE-SSOT-AUTOMATION | docs/80_traceability_decisions_and_program/SSOT_AUTOMATION_AND_LINTING.md | HOOK-SSOT-LINK-INTEGRITY | manual | Program Traceability WG | provisional-normative | docs/evidence/templates/README.md |
...
| CRE8-TRACE-REQ-0093 | CRE8-TRACE-SSOT-AUTOMATION | docs/80_traceability_decisions_and_program/SSOT_AUTOMATION_AND_LINTING.md | HOOK-SSOT-SYNC-PROMOTED-TARGET | manual | Program Traceability WG | provisional-normative | docs/evidence/templates/README.md |
...
| CRE8-TRACE-REQ-0095 | CRE8-TRACE-SSOT-AUTOMATION | docs/80_traceability_decisions_and_program/SSOT_AUTOMATION_AND_LINTING.md | HOOK-SSOT-COMMAND-EXIT-SEMANTICS | manual | Program Traceability WG | provisional-normative | docs/evidence/templates/README.md |
