...
- **HOOK-SSOT-PHASE2-EXCEPTION-REGISTER-SCHEMA**: Automated hook validating unresolved-exceptions register schema, decision linkage, and command obligations for open/blocked rows.
