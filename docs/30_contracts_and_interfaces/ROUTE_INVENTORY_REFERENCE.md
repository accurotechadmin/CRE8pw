...
| CRE8-ROUTE-0002 | POST | /v1/authz/decide | delegated | authz.decide | resource | 200 | AUTH_CREDENTIAL_INVALID,AUTH_EXPLICIT_DENY,AUTH_PERMISSION_DENIED,AUTH_SCOPE_DENIED,AUTH_DEPTH_EXCEEDED,AUTH_GRANT_EXPIRED,AUTH_LIFECYCLE_BLOCKED | active |  |  |
...
| CRE8-ROUTE-0011 | DELETE | /v1/delegations/{delegation_id} | id-key | delegation.revoke | resource | 200 | AUTH_CREDENTIAL_INVALID,AUTH_PERMISSION_DENIED | active |  |  |
...
| CRE8-ROUTE-0015 | DELETE | /v1/audience-groups/{id} | id-key | audience.group.delete | resource | 200 | AUTH_CREDENTIAL_INVALID,AUTH_PERMISSION_DENIED | active |  |  |
...
| CRE8-ROUTE-0019 | DELETE | /v1/posts/{id} | utility-key | post.delete | resource | 200 | AUTH_CREDENTIAL_INVALID,AUTH_PERMISSION_DENIED | active |  |  |
