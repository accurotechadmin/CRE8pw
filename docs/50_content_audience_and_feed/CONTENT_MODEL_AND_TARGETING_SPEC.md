...
- **CRE8-FEED-REQ-0046**: Feed/content normative rules in this document **MUST** be cross-linked to route-level examples in [`docs/30_contracts_and_interfaces/Endpoint_Examples_All_Routes.md`](docs/30_contracts_and_interfaces/Endpoint_Examples_All_Routes.md) and to machine-contract schema/example anchors in [`docs/31_machine_contracts/openapi/cre8.v1.yaml`](docs/31_machine_contracts/openapi/cre8.v1.yaml); link drift **MUST** fail `HOOK-CONTRACT-EXAMPLE-COVERAGE` or `HOOK-CONTRACT-SCHEMA-COVERAGE`.
## Verification hooks
