...
## Drift notes
- Manual verification remains primary until contract tests are implemented. Next automation hook: add `test:contract:auth_decision_tables` and register it under `HOOK-CONTRACT-POLICY-ORDER`.
