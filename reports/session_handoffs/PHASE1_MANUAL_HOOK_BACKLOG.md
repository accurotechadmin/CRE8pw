...
- Owner/session: Codex session `20260429-1320`
...
| HOOK-FEED-INTERACTION-DENY-MAPPING | CRE8-FEED-REQ-0021 | Product Policy WG | Medium | manual | HOOK-FEED-INTERACTION-DENY-MAPPING | composer test:contract:feed | Enforce one-to-one interaction deny-condition to canonical error-code mapping. |
